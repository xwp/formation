this["formation"] = this["formation"] || {}; this["formation"]["editor"] =
...
var FormationFieldInput = function FormationFieldInput(props) {
  var _getBlockType = Object(_wordpress_blocks__WEBPACK_IMPORTED_MODULE_3__["getBlockType"])(props.name),
      ...
      descriptionField = _getBlockType.descriptionField;

  var LabelComponent = label;
  var InputComponent = input;
  var DescriptionComponent = descriptionField;
...
var FormationFieldSettings = function FormationFieldSettings(props) {
  var _props$attributes = props.attributes,
      ...
      role_restriction = _props$attributes.role_restriction,
      default_value = _props$attributes.default_value,
      _unique_id = _props$attributes._unique_id,
      has_error = _props$attributes.has_error;
  props.setAttributes({
  ...
  var handleSelectChange = function handleSelectChange(role_restriction) {
    return props.setAttributes({
      role_restriction: JSON.stringify(role_restriction)
    });
  };

  var blocks = wp.data.select('core/block-editor').getBlocks();

  var checkSlug = function checkSlug(value) {
    ...
    try {
      for (var _iterator = blocks[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
        ...
        if (block.attributes.slug && block.attributes.slug === value) {
          props.setAttributes({
            has_error: __('Slug already in use')
          });
        } else {
          props.setAttributes({
            has_error: false
  ...
  }, __('Role Restriction')), react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(react_select__WEBPACK_IMPORTED_MODULE_5__["default"], {
    name: "select-two",
...
var getFieldBlocks = function getFieldBlocks() {
  ...
  var blocks = Object(_wordpress_data__WEBPACK_IMPORTED_MODULE_1__["select"])('core/block-editor').getBlocks();
  var found = [];
...
/* harmony import */ var _components_icons__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../components/icons */ "./js/src/components/icons.js");
...
var LabelField = function LabelField(props) {
  var _props$attributes = props.attributes,
      ...
      slug = _props$attributes.slug,
      required = _props$attributes.required;
  return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_1___default.a.Fragment, null, " ", show_label && react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("label", {
    for: slug
...
var BaseInput = {
  title: __('Base Field'),
  category: 'fields',
  icon: _components_icons__WEBPACK_IMPORTED_MODULE_6__["fieldIcon"],
  keywords: [__('Field'), __('Form'), __('Text')],
  supports: {
    html: false
  },
  options: ['label', 'slug', 'placeholder', 'description', 'default_value', 'required', 'repeatable'],
  example: {
    attributes: {
      label: __('Text Input'),
  ...
  edit: function edit(props) {
    var _props$attributes3 = props.attributes,
        _unique_id = _props$attributes3._unique_id,
        label = _props$attributes3.label,
        has_error = _props$attributes3.has_error;

    if (!props.isSelected) {
      // check for a slug.
      if (!label || label.length === 0) {
        wp.data.dispatch('core/block-editor').selectBlock(_unique_id);
      } else {// check slug isn't used.
      }
...
var field = _objectSpread({}, _base_input__WEBPACK_IMPORTED_MODULE_1__["default"], {
  ...
  category: 'fields',
  example: {
    attributes: _objectSpread({}, _base_input__WEBPACK_IMPORTED_MODULE_1__["default"].example.attributes, {
      label: __('Checkbox'),
      options: "Option 1\nOption 2\nOption 3\nOption 4"
    })
  },
...
/***/ "./js/src/fields/index.js":
/*!********************************!*\
  !*** ./js/src/fields/index.js ***!
  \********************************/
/*! exports provided: registerFields */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _fields__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./fields */ "./js/src/fields/fields.js");
/**
...
var registerFields = function registerFields() {
  _fields__WEBPACK_IMPORTED_MODULE_1__["FieldObjects"].forEach(function (block) {
    if (!block) {
      return;
    }
...
var field = _objectSpread({}, _base_input__WEBPACK_IMPORTED_MODULE_3__["default"], {
  ...
  example: {
    attributes: _objectSpread({}, _base_input__WEBPACK_IMPORTED_MODULE_3__["default"].example.attributes, {
      label: __('Repeatable'),
  ...
  options: ['label', 'description', 'slug', 'required'],
