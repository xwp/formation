...
var addGroup = function addGroup(event) {
  ...
  var instance_id = Math.floor(Math.random() * Math.floor(99999));
  ...
  var labels = copy.querySelectorAll('label');

  _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0___default()(labels).map(function (label) {
