<?php
/**
 * REST_API is the parent component for the Formation plugin endpoints.
 *
 * @package Formation
 */
...
class REST_API {
	...
	public function __construct( Plugin $plugin ) {
		$this->plugin    = $plugin;
		$this->endpoints = apply_filters( 'formation_api_rest_endpoints', array() );
